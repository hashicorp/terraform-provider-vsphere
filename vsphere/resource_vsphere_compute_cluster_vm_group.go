...
func resourceVSphereComputeClusterVMGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	// Convert existing and new virtual machines to string slices for diffVMs.
	...
	// Use diffVMs to find added and removed virtual machines.
	addedVMs, removedVMs := diffVMs(existingVMs, newVMs)

	// Log the added and removed virtual machines.
