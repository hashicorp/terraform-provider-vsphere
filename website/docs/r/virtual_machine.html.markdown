...
~> **NOTE:** Supported versions include 1.2 or 2.0. This setting is only available on new builds and reconfiguration to add a vTPM module; removal is not supported in the provider.
